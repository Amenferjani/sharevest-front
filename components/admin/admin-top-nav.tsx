...
export default function AdminTopNav({ isSidebarOpen, toggleSidebar, onLogout }: AdminTopNavProps) {
  return (
    <header className="bg-black border-b border-zinc-800 h-16">
      <div className="flex items-center justify-between h-full px-4">
        <div className="flex items-center">
          ...
          <div className="hidden md:flex items-center ml-4 relative">
            ...
            <Input
              ...
              className="pl-9 w-64 h-9 bg-zinc-900 border-zinc-800 focus:bg-zinc-900"
            />
          </div>
        </div>
        ...
        <div className="flex items-center space-x-3">
          ...
          <UserDropdown userName="Admin User" userEmail="admin@sharevest.io" />
        </div>
      </div>
    </header>
  )
